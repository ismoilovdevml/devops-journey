...
**1->** **Entity Framework Core** bilan **ASP.NET Core** application uchun [`Elastic.Apm.NetCoreAll`](https://www.nuget.org/packages/Elastic.Apm.NetCoreAll) paketini ishlatishingiz mumkin.
