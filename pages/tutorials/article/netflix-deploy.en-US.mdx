...
* [SonarQubeni Jenkins uchun sozlash](https://devops-journey.uz/tutorials/article/netflix-deploy#sonarqubeni-jenkins-uchun-sozlash)

* [Jenkinsga OWASP Dependency Check, JDK va Node.js pluginlarini o'rnatish va sozlash](https://devops-journey.uz/tutorials/article/netflix-deploy#jenkinsga-owasp-dependency-check-jdk-va-nodejs-pluginlarini-ornatish-va-sozlash)

* [Jenkinsda birinchi CI pipeline yozish](https://devops-journey.uz/tutorials/article/netflix-deploy#jenkinsda-birinchi-ci-pipeline-yozish)

* [Jenkins pipelinega Docker image yaratish va Docker Registryga push qiladigan bosqich qo'shish](https://devops-journey.uz/tutorials/article/netflix-deploy#jenkins-pipelinega-docker-image-yaratish-va-docker-registryga-push-qiladigan-bosqich-qoshish)
...
* **REGISTRY_URL ->** Dokcer Registry URL.
...
pipeline {
    ...
    environment {
        ...
        CONTAINER_NAME = 'netflix'
        REGISTRY_URL = 'dockerhub'
        API_KEY = 'TEST_a6ffa6aed03d65c8beb9697b674708c3_XATO' // TMDB API KEYni joylashtiring
        BRANCH_NAME = 'main'
        SCANNER_HOME = tool 'sonar-scanner'
    }
    stages {
