...
Nihoyat biz Jenkisn bilan to'liq avtomatlashtirilgan `CI/CD` pipelineni yozib bo'ldik va muffaqqiyatli ishlayapti. Keyingi bosqich ilovamiz uchun nginx configuratsiya qilib domen ulab SSL sertifikat olishdir.