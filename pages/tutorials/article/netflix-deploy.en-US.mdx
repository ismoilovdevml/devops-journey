...
kleing docker o'rnatish uchun bash scriptdan foydalanamiz. `nano` matn muharrir bilan `docker.sh` nomli fayl ochib olamiz.
...
```
Ushbu buyruq SonarQube LTS Community versiyasini `9000` portda ishga tuhsiradi. Serveringiz IP maznilida `9000` portga kirsangiz quyidagi SonarQube oynasi ochilishi kerak.
