...
Ushbu oynada siz **username** ga `admin` **passowrd** ga `admin` yozib kiramiz. Keyin bizdan oldingi parolni yozishimizni va ynagi parol qo'yishimizni so'raydi va yangi parol qo'yib sozlaymiz. sizda quyidagi oyna ochilishi kerak.
