...
Endi barcha tizim komponentlari o'rnatildi, lekin Grafana va Prometheus o'zaro ishlashi uchun sozlanmagan. Qolgan konfiguratsiya vazifalari, jumladan Prometheusni data source sifatida qoʻshish va dashboard panelini import qilish Grafana veb-interfeysi yordamida bajarilishi mumkin.
...
![monitoring](/images/article/monitoring/7.png)
