...
![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/1.jpg)
...
![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/2.png)

Biz `Install suggested plugins` opsiyasini bosamiz, bu darhol o'rnatish jarayonini boshlaydi.

![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/3.png)
...
![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/4.png)
...
![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/5.png)
...
![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/6.png)

Asosiy Jenkins boshqaruv paneliga tashrif buyurish uchun `Start using Jenkins` tugmasini bosing:

![jenkins](/images/tutorials/ci-cd/jenkins-ornatish/8.png)
