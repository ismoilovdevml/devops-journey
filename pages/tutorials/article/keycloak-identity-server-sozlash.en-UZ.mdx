...
Mundarija:
* **[Ishni boshlash](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#ishni-boshlash)**

**[Keycloak o'rnatish](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#keycloak-ornatish)**

* **[16 versiyadan oldingilar](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#16-chi-versiyagacha)**
* **[16 versiyadan keyingilar](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#16-chi-versiyadan-keyingilar)**
* **[16 versiyadan keyingilarni production modeda ishgab tushirish](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#16-chi-versiyadan-keyingilarni-production-modeda-ishgab-tushirish)**

**[Keycloakni PostgeSQL'ga ulash](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#16-chi-versiyadan-keyingilarni-production-modeda-ishgab-tushirish)**

* **[Keycloakni PostgeSQL'ga ulash(16 versiyadan yuqori)](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#16---versiydan-keyingi-keycloak)**
* **[Keycloakni PostgeSQL'ga ulash(16 versiyadan kichik)](https://devops-journey.uz/tutorials/article/keycloak-identity-server-sozlash#16---versiyadan-kichik)**
</Callout>
