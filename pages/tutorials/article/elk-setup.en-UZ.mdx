...
* Monitoring qilmqochi bo'lgan serverlarga Metricbeat o'rnating
...
Auditbeat ishlayotgan operatsion tizimga qarab, Linux audit tizimidan yoki Windows vevent loglaridan ma'lumotlarni to'playdi. U file access,process execution, user authentication, va system-leveldagi boshqa activitilar kabi keng ko'lamli eventlarni yozib olishi mumkin.
