...
![minio-server-sozlash](/images/article/minio-server/banner.png)
...
![minio-server-sozlash](/images/article/minio-server/minio1.png)
...
![minio-server-sozlash](/images/article/minio-server/minio2.png)
![minio-server-sozlash](/images/article/minio-server/mino3.png)
...
![minio-server-sozlash](/images/article/minio-server/minio4.png)
...
![minio-server-sozlash](/images/article/minio-server/minio6.png)
...
![minio-server-sozlash](/images/article/minio-server/ahost.png)
...
Siz buni quyidagicha emalga oshirasiz **teshmat@gmail.com** o'rniga ishlaydigan o'zingizning emailingizni yozing.
![minio-server-sozlash](/images/article/minio-server/server.png)
![minio-server-sozlash](/images/article/minio-server/server1.png)

**6->** Okey hammasi yaxshi keling endi Minio S3 API ni test qilib ishlatib ko'ramiz. Buning uchun Minio Console UIdan birorta bucket ochib uni public qilamiz va birorta rasm yuklaymiz bucketimizga uniURL manizilini olib birorta brauzerdan kirib ko'rsak shu rasmni berilgan odmen va path orqali ochishi kerak.
...
Hammasini yakunlaganimizdan keyin minio-ui.xilol.uz domeniga brauzerdan kirganimizda htps bilan Minio Console UI ochilishi kerak. SSL sertifikat olib Chrome brauzerdan kirsa SSLni sezishi biroz vaqt oladi ya'ni SSL yo'q deb turadi. Firefox ancha tezkor ishlaydi.

![minio-server-sozlash](/images/article/minio-server/server2.png)

Uhh nihoyat biz barchasini muvaffaqiyat yakunladik. Biz minioni binary holatda o'rnatdik va SsystemD orqali bosghqarish uchun service konfiguratsiya qilidik  va Minio qo'shimcha sozlamalar uchun konfig yaratib  minio fayllarni saqlash joyini **/mnt/data**ga bog'ladik. Minio S3 API va Minio Console UIga Nginx konfiguratsiya qilib domen ulab cerbot orqali SSL sertifikat olib ishga tushirdik.

Bizda hozir

* **[minio-ui.xilol.uz](https://minio-ui.xilol.uz/)->** Bu Minioni boshqarish uchun  Console UI.
* **[minio-api.xilol.uz](https://minio-api.xilol.uz/)->** Bu applicationlarimiz ulanioshi uchun Minio S3 API
