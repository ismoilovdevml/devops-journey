...
<section className="py-12">
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="bg-green-50 dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-green-300 dark:border-gray-700 mb-12">
      ...
      <ul className="mt-2 space-y-2">
        {[
          "Onboarding jarayoni, loyihaga yechim berishdan oldin o'rganib chiqib keyin yechim qilinadi.",
          "Maxvfiylik siyosatiga amal qilinadi ikki tomondan.",
          "Konsultatsiyadan tashqari ishlarda ham kelishuvlar qilishimiz mumkin.",
          "Taklif qilinayotgan mutaxasisslar bilan ish kelishuvlarini o'zingiz belgilaysiz."
        ].map((item, idx) => (
          <li key={idx} className="flex items-center text-gray-800 dark:text-gray-200">
            <span className="inline-block w-3 h-3 mr-2 bg-green-500 rounded-full"></span>
            {item}
      ...
      {[
        {
          ...
          email: "mailto:akhmadiy@gmail.com?subject=Consultatsiya so'rovi&body=Salom, men consultatsiyaga yozilmoqchiman..."
        },
        {
        ...
        },
        {
          ...
          experience: "10 yil+",
          workplaces: "Shaxsiy biznes, IT-Park, Uzinfocom",
          consultTime: "60 min",
          price: "1.200.000 so'm",
          linkedin: "https://manu.uz/",
          email: "mailto:yetimdasturhi@gmail.com?subject=Consultatsiya so'rovi&body=Salom, men consultatsiyaga yozilmoqchiman..."
        },
        {
          ...
          email: "mailto:qhd1996@gmail.com                                     ?subject=Consultatsiya so'rovi&body=Salom, men consultatsiyaga yozilmoqchiman..."
        },
        {
