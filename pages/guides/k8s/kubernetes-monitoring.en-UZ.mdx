...
* [**Prometheus nima?**](https://devops-journey.uz/guides/database/postgres-monitoring#prometheus-nima)
* [**Grafana nima?**](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-nima)
* [**Grafana Dashboardni import qilish**](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-dashboardni-import-qilish)
