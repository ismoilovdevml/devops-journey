...
![k8s-cluster](/images/tutorials/k8s/cluster-setup/k8s-draw.png)
...
![k8s-cluster](/images/tutorials/k8s/cluster-setup/longhorn.png)
...
DNS hostimizdan domenimizni k8s-master static IP manizlini ulaymiz va konfiguratsiyamizni apply qilamiz.
...
![k8s-cluster](/images/tutorials/k8s/cluster-setup/dashboard2.png)
...
**Oxirgi yangilanish:** 2024.02.06(2024-yil 6-fevral)
