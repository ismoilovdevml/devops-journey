...
Kubernetes clusterimizga Cert-Manager o'rnatish bo'yicha devops-journey platformasi qo'llanma mavjud bo'lib ushu [**Kubernesga Cert-Manager o'rnatish va sozlash**](https://devops-journey.uz/guides/k8s/k8s-cert-manager) qo'llamadan foydalanib o'rnatib sozlab olishingiz mumkin.
...
**4->** NGINX Ingress bilan Kubernes dashboardni odmen ulab expose qilamiz.
...
DNS hostingdan domengizga k8s-master static Ip manzilini qo'shib qo'yasiz. Ushbu misolda menda **xilol.uz** domeni bor va men **dashboard** deb subdomen qo'shyapman. Rasmda ahost numnasi ko'rsatilgan **0.0.0.0** o'rniga k8s-matser serveringiz static IP manzilini qo'shasiz.
...
Configuratsiyamizni apply qilib ishga tushirganimizdan keyin brauzerdan **dashboard.xilol.uz**ga kirganimzida **https** kirihsi kerak va bizga Kubernetes Dashboard ochilib kirish oynasi ochilishi kerak.
...
Token olib dashboardga kira olamiz.
