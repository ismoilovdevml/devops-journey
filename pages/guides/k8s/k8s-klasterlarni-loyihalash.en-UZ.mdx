...
* **Xavfsizlik izolyatsiyasining yetishmasligi->**  Applicationlar bir xil hardware va tarmoq resurslarini shared ishlatadi. Bu xavfsizlik zaifliklariga olib kelishi mumkin. Masalan Yandex Market service xavfsizlik zaifligi bo'lsa, bu zaiflik orqali Yandex Taxi yoki Yandex Music servicelariga kirib olish xavfi oshadi.
