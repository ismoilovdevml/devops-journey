...
* [Control Plane](https://devops-journey.uz/guides/k8s/k8s-architecture#control-plane)
* [Worker Node](https://devops-journey.uz/guides/k8s/k8s-architecture#worker-node)

**Kubernetes Control Plani komponentlari**

* [kube-apiserver](https://devops-journey.uz/guides/k8s/k8s-architecture#kube-apiserver)
* [etcd](https://devops-journey.uz/guides/k8s/k8s-architecture#etcd)
* [kube-scheduler](https://devops-journey.uz/guides/k8s/k8s-architecture#kube-scheduler)
* [Kube Controller Manager](https://devops-journey.uz/guides/k8s/k8s-architecture#kube-controller-manager)
* [Cloud Controller Manager (CCM)](https://devops-journey.uz/guides/k8s/k8s-architecture#cloud-controller-manager-ccm)

**Kubernetes Worker Node komponentlari**

* [Kubelet](https://devops-journey.uz/guides/k8s/k8s-architecture#kubelet)
* [Kube proxy](https://devops-journey.uz/guides/k8s/k8s-architecture#kube-proxy)
* [Container Runtime](https://devops-journey.uz/guides/k8s/k8s-architecture#container-runtime)
...
![k8s](/images/tutorials/k8s/architecture/15.png)
...
![k8s](/images/tutorials/k8s/architecture/16.png)
...
![k8s](/images/tutorials/k8s/architecture/17.png)
...
![k8s](/images/tutorials/k8s/architecture/18.png)
...
**containerd** sanoat standartidagi asosiy container runtime. U Linux va Windows uchun demon sifatida mavjud boʻlib, u oʻzining xost tizimining toʻliq container lifecycleni boshqara oladi: imageni uzatish va saqlash, containerni execute qilish va nazorat qilish, low-level storage va tarmoq qoʻshimchalari va boshqalar.
...
![k8s](/images/tutorials/k8s/architecture/19.png)
