...
* etcd clientga Watch() API yordamida eventlarga subscribe qilish imkonini beradi. Kubernetes api-server object holatidagi(state) o'zgarishlarni(change) kuzatish uchun etcd-ning `watch` funksiyasidan foydalanadi.
...
* Bu API serverida pod create(yaratish) eventlarini tinglaydigan kontroller.
