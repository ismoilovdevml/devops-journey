...
![kubespray](/images/tutorials/k8s/kubespray/k8s.png)
...
**4->** MetalLBdan oldin sozlash yakunlangandan keyin MetalLBni helm orqali o'rnatib olamiz. Kubespray ishga tushirib kubernetes cluter yaratganimizda helm ham o'rnatiladi ya'ni helm o'rntishga hojat yo'q.
...
![kubespray](/images/tutorials/k8s/kubespray/server2.png)
...
![kubespray](/images/tutorials/k8s/kubespray/k8s2.png)
...
![kubespray](/images/tutorials/k8s/kubespray/k8s-draw.png)
...
![kubespray](/images/tutorials/k8s/kubespray/k8s3.png)
...
```
![kubespray](/images/tutorials/k8s/kubespray/k8s4.png)
