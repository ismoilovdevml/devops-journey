...
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/actions5.png)
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/actions6.png)

Hamma bosqichlat muvaffaqiyat tugaganida.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/actions7.png)

Barcha bosqichlar muvaffaqiyat tugaganidan keyin Github Repositoriyamizda **Release** bo'limda **v1.0.1** verisyali release chiqgan bo'lishi kerak.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/actions8.png)

**Release**ga kirganimizda Soirce kodlar va Android release **.apk** formatda applicationni olamiz,
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/actions9.png)
...
- name: Set up Flutter
  ...
  with:
    ...
    channel: 'stable'
```
Bu qsim [actions/cache@v4](https://github.com/actions/cache) orqali Gradleni keshlaydi bu keyingi bosqichlar tezlashtirishga yordma beradi.
...
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scanning1.png)

**2->** **Code scanning**  bo'limidan **other tools**dan **Explore workflows** bosib actionslar ro'yxatiga kiramiz.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scanning2.png)

**3->** Bu qisdan **scorecard** deb qidirib **OSSF Scorecard**dan **Configure** bosib konfiguratsiya qo'yish bo'limiga o'tamiz.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scanning3.png)

**4->** Ushbu qismdan default YAML konfiguratsiyani o'chirib tahslab quyidagi configuratsiyani joylashtirishimiz kerak.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scanning4.png)
...
konfiguratsiyani o'zgartirganimzidan keyin **Commit changes**'ni bosib main branchga commit qilamiz.

![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scanning5.png)

**5->** Scorecardni konfiguratsiya qilib Github Repositoiyamiz **Actiosn** bo'limidan jarayonni kuzatib borishimiz mumkin.

![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scorecard1.png)
Okeyyy hammasi muvaffaqiyat ishga tushgan endi Security alertlarni ko'rish uchun Github Repositoiyamizdan **Security -> Code scanning** bo'limiga o'tib ko'rishimiz mumkin.

![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/scorecard2.png)

Biz bu yerda loyihamizning Security alertlarini ko'rishimniz mumkin.
...
Keling ushbu Github Actionsni ishga tuhsirmasdan oldin ko'rib chiqamiz.

Birinchi belgilangan konfiguratsiya **name:** bu Github Actiosni nomini bildiradi. 

* **workflow_dispatch:** qo'lda manual ishga tushirishni yoqadi. 
* **inputs:** bu Github Actionsda kirishlarni bildiradi. Uni ichida yozilgan konfiguratsiya esa **description** tavsifni bildiradi va manual run qilganda ikkata tanlovdan(**beta va production**)ni tanlashni bildiradi. Default holda beta ishga tushadi **required: true** orqali birortasini tanlash majburisy qilib qo'yilgan. **permissions: read-all** esa ushbu Repositoiyada barchasifaqa read(o'qish) ruxsatiga egalikni bildiradi.
```bash {1,4,9,11-13,14}
name: Deploy to Play Store
on:
  # Enable manual run
...
> Siz Play Store akkount ochib olishingiz kerak bo'ladi va ilovangiz uchun kerakli key kalitlarni olib Github Secretsga joylashtirib qo'yasiz

![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/secret1.png)
...
**-> Github Repositoiya -> Actions -> All workflows** da **Deploy To Play Store** deb bizni Actionimiz chiqib turadi.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/play-store1.png)
...
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/play-store2.png)
Okeeey bizda jarayon muvaffaqiyat tugadi.
![flutter-ci-cd](/images/tutorials/ci-cd/flutter-cicd/play-store4.png)
