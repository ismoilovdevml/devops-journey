...
Bu **Trigger** qsimi hisoblanadi bu yuqorida tushuntirib o'tildi.
```bash
name: Test, Build and Release APK
...
- name: Set up Flutter
  ...
  with:
    ...
    channel: 'stable'
```
Bu qsim [actions/cache@v4](https://github.com/actions/cache) orqali Gradleni keshlaydi bu keyingi bosqichlar tezlashtiradi.
...
- name: Cache Gradle dependencies
  ...
  with:
    ...
    restore-keys: |
      ${{ runner.os }}-gradle-
```
**flutter pub get** buyrug'i orqali flutter loyaimiz dependencilarni oladi.
