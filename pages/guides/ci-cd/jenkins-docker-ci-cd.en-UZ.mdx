---
image: https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/banner.png
description: "Koddan Servergacha: Jenkins bilan Docker CI/CD va Discord bilan integratsiya"
---
...
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/banner.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/github1.png)

Keyin **Developer settings** bo'limga kiring.

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/github2.png)

**Personal access tokens** **->** **Tokens(classic)**
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/github3.png)

**->Generate new token(classic)**
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/github4.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/github5.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/github6.png)

### Gitlab uchun

Gitlab profilingizga kirib **Pereferences** bo'limga kirib **Accsess Tokens**ga o'tamiz.

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gitlab1.png)

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gitlab2.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gitlab3.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/jenkins1.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/jenkins3.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord1.png)

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord2.png)

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord3.png)

Serverga nom berib **Create** bosamiz.

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord4.png)

Discord Server yaratib olganimzidan keyin Serverimizda channel yaratib olamiz. **Create Channel**

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord6.png)

Channel nomini yozamiz masalan **dev-jenkins** -> **Create Channel**
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord7.png)

Channel ochib olganimzidan keyin **Integrations** bo'limga kirib **Webhooks**dan **Create Webhook** bosamiz
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord8.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord9.png)

Discordan olgan webhookni Jenkins credendialsga qo'shamiz.

**->** `Manage Jenkins` **->** `Credentials`

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/jenkins4.png)
...
>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/job1.png)

**Enter an item name** ga loyihamiz nomini yozib **Pipeline**ni tanlab **OK** bosamiz

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/job2.png)

Keyingi qismda eng pastgi qatorga **Pipeline** qismiga quyidagi birinchi CI pipelinemizni joylashtiramiz **Save** qilamiz.

>![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/job3.png)
...
> ![netflix](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/job4.png)

> ![netflix](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/discord10.png)
...
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp1.png)

**2 -> + CREATE SERVICE ACCOUNT** bosib service account yaratib olamiz.

![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp2.png)
...
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp3.png)

**4 -> Role**ga **Storage Admin** huquqini beramiz va **DONE** bosib yaratib olamiz.
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp4.png)
...
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp5.png)

**7->** Yuklab olgan Service account  private keyimizni Jenkins credentialsga qo'shib qo'yamiz.

**->** `Manage Jenkins` **->** `Credentials`-ga kirib  `Add credentials`ga o'tamiz.

![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp6.png)
...
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/gcp7.png)
...
![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/item1.png)

![docker-ci-cd](https://raw.githubusercontent.com/devops-journey-uz/assets/main/images/tutorials/ci-cd/jenkins-docker/item2.png)
