...
Email bilan integratsiya ham oddiy, o'zingizga moslab konfiguratsiya qilasiz va kimlarni emailiga notification yuborish keraligi belgilanadi.

![gitlab-ci](/images/tutorials/ci-cd/gitlabci-release-integrations/email.png)

Emailga quyidagicha notification keladi.
![gitlab-ci](/images/tutorials/ci-cd/gitlabci-release-integrations/email1.png)