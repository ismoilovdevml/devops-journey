...
Prometheus haqida malumot va o'rnatish uchun quyidagi qo'llanmani ko'rib chiqishingiz mumkin. [To'liq qo'llanma](https://devops-journey.uz/guides/database/postgres-monitoring). [Prometheus nima?](https://devops-journey.uz/guides/database/postgres-monitoring#prometheus-nima), [Prometheus o'ratish va sozlash](https://devops-journey.uz/guides/database/postgres-monitoring#prometheus-oratish-va-sozlash), [Prometheusni service sifatida sozlash](https://devops-journey.uz/guides/database/postgres-monitoring#prometheusni-service-sifatida-sozlash)
...
Prometheus haqida malumot va o'rnatish uchun quyidagi qo'llanmani o'qib chiqing. [Grafana nima?](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-nima), [Grafana serverini qanday o'rnatish va sozlash](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-serverini-qanday-ornatish-va-sozlash), [Grafana va Prometheusni integratsiya qilish](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-va-prometheusni-integratsiya-qilish), [Grafana Dashboardni import qilish](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-dashboardni-import-qilish)
...
Agar siz Grafanaga dashboard qo'ya olmagan bo'lsangiz Grafanaga dashboard qo'yicha bo'yicha quyidagi qo'llanmani o'qib chiqing. [Grafana Dashboardni import qilish](https://devops-journey.uz/guides/database/postgres-monitoring#grafana-dashboardni-import-qilish)
 ...
 * [**Serverlarni monitoring qilish**](https://devops-journey.uz/guides/database/postgres-monitoring)
