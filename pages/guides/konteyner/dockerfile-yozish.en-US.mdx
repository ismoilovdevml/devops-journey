...
`VOLUME` instructioni Docker konteynerida mount point yaratish uchun ishlatiladi va konteyner tomonidan yaratilgan ma'lumotlarni doimiy ravishda saqlash yoki konteyner va ost mashinasi o'rtasida ma'lumotlarni almashish uchun ishlatiladi.

`VOLUME` instructioni sintaksisiga msiol:
...
* **Ixtisoslashgan ma'lumotlar konteynerlari(Specialized Data Containers):** volumelarni konteynerlar o'rtasida ham taqsimlash(share) mumkin. Nomlangan volumeni yaratish bir nechta konteynerlarga bir xil ma'lumotlarni almashish imkonini beradi.
